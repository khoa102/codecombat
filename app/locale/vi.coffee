...
#    why_paragraph_2_center: "but fun like"
    whyparagraph__italic_caps: "LÀM XONG MÀN NÀY CON SẼ XUỐNG MẸ ƠI"
...
#    ambassador_summary: "Tame our forum users and provide direction for those with questions. Our ambassadors represent CodeCombat to the world."
  ...
  editor:
    main_title: "Trình soạn cấp độ CodeCombat"
...
#    adventurer_introduction: "Let's be clear about your role: you are the tank. You're going to take heavy damage. We need people to try out brand-new levels and help identify how to make things better. The pain will be enormous; making good games is a long process and no one gets it right the first time. If you can endure and have a high constitution score, then this class might be for you."
    adventurer_attribute_1: "Một khát khao được học hỏi. Bạn muốn học làm thế nào để lập trình và chúng tôi muốn dạy bạn điều đó. Tuy nhiên hầu hết là bạn sẽ phải tự thân vận động."
