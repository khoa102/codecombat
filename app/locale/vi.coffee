...
##    tip_superpower: "Coding is the closest thing we have to a superpower."
    tip_superpower: "Coding là điều gần với siêu năng lực nhất mà chúng ta có."
...
##    options_caption: "Configure settings"
    options_caption: "Chỉnh sửa settings"
...
##    confirm_unsubscribe: "Confirm Unsubscribe"
    confirm_unsubscribe: "Xác Nhận Unsubscribe"
...
##    sorry_to_see_you_go: "Sorry to see you go! Please let us know what we could have done better."
    sorry_to_see_you_go: "Chúng tôi rất tiếc khi thấy bạn bỏ đi! Hãy cho chúng tôi biết chúng tôi cần phải làm điều gì tốt hơn." 
    unsubscribe_feedback_placeholder: "Ồ, chúng tôi đã làm gì sai ư?"
    parent_button: "Hãy hỏi bố mẹ bạn"
##    parent_email_description: "We'll email them so they can buy you a CodeCombat subscription."
    parent_email_description: "Chúng tôi đã gửi email cho họ để họ có thể mua cho bạn một gói subscription của CodeCombat." 
...
##    current_recipients: "Current Recipients"
    current_recipients: "Người nhận hiện giờ"
    unsubscribing: "Unsubscribing"
##    subscribe_prepaid: "Click Subscribe to use prepaid code"
    subscribe_prepaid: "Hãy nhấn Subscribe để sử dụng mã trả trước"  
##    using_prepaid: "Using prepaid code for monthly subscription"
    using_prepaid: "Sử dụng mã trả trước cho subscription hàng tháng"
...
##    level_to_unlock: "Level to unlock:" # Label for which level you have to beat to unlock a particular hero (click a locked hero in the store to see)
    level_to_unblock: "Level để mở: "
##    restricted_to_certain_heroes: "Only certain heroes can play this level."
    restricted_to_certain_heroes: "Chỉ có một số nhân vật nhất định có thể chơi level này."
  skill_docs:
##    writable: "writable" # Hover over "attack" in Your Skills while playing a level to see most of this
    writable: "có thể viết"
##    read_only: "read-only"
    read_only: "Chỉ có thể đọc"
##    action: "Action"
    action: "Hành động" 
##    spell: "Spell"
    spell: "Phép"
...
##    action_specific_cooldown: "Cooldown"
    action_specific_cooldown: "Làm lạnh"
    action_damage: "Damage"
##    action_range: "Range"
    action_range: "Phạm vi hành động" 
...
#    artisan_attribute_1: "Any experience in building content like this would be nice, such as using Blizzard's level editors. But not required!"
    artisan_attribute_2: "Phải có quyết tâm cao độ để có đủ nhẫn nải thử và bổ sung. Để có thể làm được những cấp độ tốt, bạn cần phải đem nó đi thử bởi nhiều người, và hãy chuẩn bị tinh thần phải ngồi sửa lỗi."
#    artisan_attribute_2: "A hankering to do a whole lot of testing and iteration. To make good levels, you need to take it to others and watch them play it, and be prepared to find a lot of things to fix."
    artisan_attribute_3:"Tạm thời thì muốn làm nhà thám hiểm thì đồng nghĩa với việc rèn tính M đang ẩn nắp trong bạn tí. Trình soạn cấp độ của chúng tôi cực kì khó sử dụng đấy, báo trước rồi nha!"
#    artisan_attribute_3: "For the time being, endurance en par with an Adventurer. Our Level Editor is super preliminary and frustrating to use. You have been warned!"
    artisan_join_desc: " Hãy dùng trình soạn cấp độ theo những bước sau:"
#    artisan_join_desc: "Use the Level Editor in these steps, give or take:"
    artisan_join_step1: "Nhớ đọc tài liểu nha."
#    artisan_join_step1: "Read the documentation."
    artisan_join_step2: "Tạo cấp độ mới trong khi coi thử các cấp độ đã có."
#    artisan_join_step2: "Create a new level and explore existing levels."
    artisan_join_step3: "Tìm đến chúng tôi trên kênh đại chúng trên Slack khi cần giúp đỡ."
#    artisan_join_step3: "Find us in our public Slack channel for help."
    artisan_join_step4:"Đăng cấp độ của bạn lên diễn đàn để được cho nhận xét."
#    artisan_join_step4: "Post your levels on the forum for feedback."
    artisan_subscribe_desc:"Nhận email về những cập nhật của trình soạn cấp độ và thông báo."
#    artisan_subscribe_desc: "Get emails on level editor updates and announcements."
    adventurer_introduction: "Hãy rạch ròi trong vai trò của bạn nào: bạn là chiếc xe tăng. Bạn sẽ phải chường xác thịt ra để nhận sát thương. Chúng tôi sẽ cần bạn phiêu lưu vào những cấp độ mới và đưa ra những phát kiến để phát triển nó thêm. Sẽ gian khổ và nhiều cam go lắm đó, làm trò chơi không phải là chuyện ngày một ngày hai là xong. Nếu bạn vẫn còn nghĩ mình có thể chịu được hay vẫn tự tin vào bản chất chôn sâu trong mình, phân loại này hoàn toàn có thể dành cho bạn.  "
